              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">攻略名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="gonglveName" id="gonglveName"  placeholder="攻略名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">攻略类型:</span>
                        <div class="layui-input-inline">
                            <select name="gonglveTypes" id="gonglveTypes" lay-filter="gonglveTypes" style="width: 600px;">
