            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">自驾游攻略展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gonglveName" id="gonglveName" placeholder="攻略名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="gonglveTypes" id="gonglveTypes" lay-filter="gonglveTypes">
                                  ...
                                  <option v-for="item in gonglveTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../gonglve/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img :src="item.gonglvePhoto?item.gonglvePhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../gonglve/detail.jsp?id='+item.id)"><span>{{item.gonglveName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.gonglveNewMoney"><span style="color: red;">{{item.gonglveNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#gonglveName').val() != null && jquery('#gonglveName').val() != "" && jquery('#gonglveName').val() != "null" ) {
                param['gonglveName'] = jquery('#gonglveName').val();
            }
     
            var gonglveTypes = $("#gonglveTypes").find("option:selected").val();
            if (gonglveTypes != null && gonglveTypes != "" && gonglveTypes != "null") {
                param['gonglveTypes'] = gonglveTypes;
            }
                            // 获取列表数据
            http.request('gonglve/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function gonglveTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=gonglve_types", 'get', {}, function (res) {
               if(res.code == 0){
